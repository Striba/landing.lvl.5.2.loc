                ...
                <div class="row">
                  <div class="col-lg-5 col-sm-7">
                    <div class="top_left_cont zoomIn wow animated"> 
                      {!! $page->text !!}<!-- ! - знак для того,
                                 чтобы не экранировались HTML тэги, 
                                 которые у нас будут выводиться из БД -->
                  ...
                  <div class="col-lg-7 col-sm-5">
                                ...
                                <!-- Здесь применяется доп пакет HTML&FORMS Свойсвто image  фассада Html формирует тэг <img>, геренируя автопуть урл -->
                          </div>
                </div>
              </div>
            </div>
